            ...
            <div className="container">
                <div className="row align-items-center justify-content-between">
                    ...
                    <div className="col-lg-5 col-md-12 about-right">
                        ...
                        <a href={resumeColor} className="primary-btn" data-text="Resume" download>
                            <span>R</span><span>E</span><span>S</span><span>U</span><span>M</span><span>E</span>
                        </a>

                        {page === 'about' ? (
                            <a href={resumePrintable} className="primary-btn white small-font" style={{ marginLeft: '10px' }} data-text="Printing? Use this instead." download>
